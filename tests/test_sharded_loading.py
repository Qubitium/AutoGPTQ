...
class TestShardedLoading(unittest.TestCase):
    ...
    def test_loading_large(self):
        ...
        model = AutoGPTQNextForCausalLM.from_quantized("Qwen/Qwen1.5-7B-Chat-GPTQ-Int4", device="cuda:0")
        ...
        self.assertTrue(
            result
            == "Today I am in Paris and I am going to the Louvre Museum. I want to see the Mona Lisa painting, but I"
        )
